...
export const getCryptoSymbol = async (symbol: string, options?: RequestInit): Promise<getCryptoSymbolResponse> => {
  
  return fetcher<Promise<getCryptoSymbolResponse>>(getGetCryptoSymbolUrl(symbol),
  {      
    ...options,
    method: 'GET'
...
export const getGetCryptoSymbolQueryOptions = <TData = Awaited<ReturnType<typeof getCryptoSymbol>>, TError = GetCryptoSymbol404>(symbol: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getCryptoSymbol>>, TError, TData>>, request?: SecondParameter<typeof fetcher>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCryptoSymbolQueryKey(symbol);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getCryptoSymbol>>> = ({ signal }) => getCryptoSymbol(symbol, { signal, ...requestOptions });

      

      

   return  { queryKey, queryFn, enabled: !!(symbol), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCryptoSymbol>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}

export type GetCryptoSymbolQueryResult = NonNullable<Awaited<ReturnType<typeof getCryptoSymbol>>>
export type GetCryptoSymbolQueryError = GetCryptoSymbol404


export function useGetCryptoSymbol<TData = Awaited<ReturnType<typeof getCryptoSymbol>>, TError = GetCryptoSymbol404>(
 symbol: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getCryptoSymbol>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetCryptoSymbol<TData = Awaited<ReturnType<typeof getCryptoSymbol>>, TError = GetCryptoSymbol404>(
 symbol: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getCryptoSymbol>>, TError, TData>>, request?: SecondParameter<typeof fetcher>}
