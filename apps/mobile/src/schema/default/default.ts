...
export const getAlert = async (
  ...
  return fetcher<Promise<getAlertResponse>>(getGetAlertUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetAlertQueryKey = () => {
  return [`http://localhost:4003/alert`] as const;
};
...
>(options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getGetAlertQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getAlert>>> = ({
    signal,
  }) => getAlert({ signal, ...requestOptions });
...
>(options?: {
  ...
  const queryOptions = getGetAlertQueryOptions(options);
...
export const getGetCryptoUrl = (params?: GetCryptoParams) => {
  ...
  return normalizedParams.size
    ? `http://localhost:4003/crypto?${normalizedParams.toString()}`
    : `http://localhost:4003/crypto`;
};
...
>(
  ...
  options?: {
    query?: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getCrypto>>, TError, TData>
    >;
    request?: SecondParameter<typeof fetcher>;
  }
) => {
...
export function useGetCrypto<
  ...
  TError = GetCrypto404
>(
  params: undefined | GetCryptoParams,
  options: {
    query: Partial<
      UseQueryOptions<Awaited<ReturnType<typeof getCrypto>>, TError, TData>
    > &
